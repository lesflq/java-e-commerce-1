...
class ProductControllerIT {
    ...
    void testCreateProduct() throws Exception {
        ...
        ProductDTO productDTO = ProductDTO.builder().name("Test Product Star").price(BigDecimal.valueOf(100.0)).build();

        ProductDTO createdProduct = ProductDTO.builder().name("Test Product Comet").price(BigDecimal.valueOf(1523.0)).build();
    ...
    void testUpdateProduct() throws Exception {
        ...
        ProductDTO updatedProduct = ProductDTO.builder().name("Test Product Comet").price(BigDecimal.valueOf(1902.0)).build();
